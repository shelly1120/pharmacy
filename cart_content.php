...
<?php if ($cart_rs->rowCount() != 0) { ?>
    ...
    <button type="button" id="btn01" name="btn01" class="btn btn-success" onclick="btn_confirmLink('確定清空購物車?','shopcart_del.php?mode=2');">清空購物車</button>
    <a href="checkout.php" id="btn01" name="btn01" class="btn btn-warning">前往結帳</a>
